...
class SolrDocument(TypedDict):
    ...
    edition_name: Optional[list[str]]
    ...
    series_key: Optional[list[str]]
    series_name: Optional[list[str]]
    series_position: Optional[list[str]]
